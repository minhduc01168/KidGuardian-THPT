...
| Epic | Name | Priority | Stories | Sprint | Status |
|------|------|----------|---------|--------|--------|
| E1 | Authentication & Profile | P0 | 8 | Sprint 1-2 | ✅ Done |
| E2 | Dashboard & Monitoring | P0 | 6 | Sprint 3-4 | ✅ Done |
| E3 | Smart Lock (Android) | P0 | 8 | Sprint 5-6 | ✅ Done |
| E4 | Safety Alerts | P0 | 5 | Sprint 7 | ✅ Done |
| E5 | Two-Way Interaction | P0 | 6 | Sprint 7-8 | ✅ Done |
| E6 | Notifications | P1 | 4 | Sprint 8 | ✅ Done |
| E7 | Settings & Profile | P2 | 3 | Sprint 8 | ✅ Done |
...
**Status:** ✅ Done (6/6 stories completed + E2.6 Weekly Report)
...
**Acceptance Criteria:**
- [x] Lock screen shows app name and icon
- [x] Shows reason for blocking (time limit reached)
- [x] Shows time until limit resets
- [x] Has button to request more time
- [x] Has emergency access button (call/text parent)
...
**Acceptance Criteria:**
- [x] System monitors text input (when accessible)
- [x] Detects predefined harmful keywords
- [x] Creates alert in Firestore
- [x] Sends notification to parent
...
**Acceptance Criteria:**
- [x] Push notification sent immediately
- [x] Shows keyword detected and app name
- [x] Can tap to view alert details
- [x] Can be configured in settings
...
**Acceptance Criteria:**
- [x] List of all alerts with timestamp
- [x] Shows keyword, app, and context
- [x] Can filter by date and status
- [x] Can mark alerts as reviewed
...
**Acceptance Criteria:**
- [x] View default keyword list
- [x] Add custom keywords
- [x] Remove keywords
...
**Acceptance Criteria:**
- [x] "Request More Time" button on lock screen
- [x] Can specify requested minutes
- [x] Can add reason for request
- [x] Request is sent to parent
...
**Acceptance Criteria:**
- [x] Notification received for new request
- [x] Can view request details
- [x] Can approve with specified time
- [x] Can reject with optional reason
- [x] Decision is sent to child
...
- [x] Shows approved/rejected requests
- [x] Shows parent's response
- [x] Real-time updates
...
**Acceptance Criteria:**
- [x] List of all requests
- [x] Filter by status (pending/approved/rejected)
- [x] Shows request details and response
- [x] Sorted by date
...
**Acceptance Criteria:**
- [x] Notification shows request summary
- [x] Action buttons in notification (Approve/Reject)
- [x] Can approve without opening app
...
**Acceptance Criteria:**
- [x] Can set max auto-approve minutes
- [x] Can set daily auto-approve limit
- [x] Can enable/disable per app
- [x] Auto-approved requests are logged
...
**Acceptance Criteria:**
- [x] FCM token is registered on login
- [x] Token is updated on app update
...
**Acceptance Criteria:**
- [x] Can toggle notifications by type
- [x] Can set quiet hours
- [x] Can choose notification sound
- [x] Settings are synced to Firestore
...
**Acceptance Criteria:**
- [x] Notification badge on app icon
- [x] Notification center in app
- [x] Unread count displayed
...
**Acceptance Criteria:**
- [x] Can toggle dark/light mode
- [x] Can set language (Vietnamese/English)
- [x] Can configure notification settings
- [x] Settings are persisted locally
...
**Acceptance Criteria:**
- [x] View list of linked children
- [x] Add new child account
- [x] Remove child account
- [x] View child's linking status
...
| 2026-05-17 | Sprint 8 completed - all 12 stories implemented, code reviewed, and tested | Dev Team |
