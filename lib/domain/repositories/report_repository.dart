...
abstract class ReportRepository {
  ...
  Future<MonthlyReport> generateMonthlyReport(String childUid, String familyId);
  Future<List<WeeklyReport>> getReportsByFamily(String familyId, {int limit = 4});
  Future<List<MonthlyReport>> getMonthlyReportsByFamily(String familyId, {int limit = 4});
  Future<List<WeeklyReport>> getReportsByChild(String childUid, {int limit = 4});
  Future<List<MonthlyReport>> getMonthlyReportsByChild(String childUid, {int limit = 4});
